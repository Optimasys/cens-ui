                  ...
                  {currentStep === 2 && (
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        />
                        <p className="text-[#0D6B6B] text-[14px] mt-1">File name for the essay must be written as <br/>IEC(No. Of Sub-Theme)_Team Name_University <br/>Example: IEC1_Cens_UI or IEC2_Cens_UI</p>
                        {selectedFile && (
